...
public class AddCustAndList {
	 WebDriver driver;
	  ...
	  //here we use contains method for text. because there is a span.
		...
		By SEARCH=By.xpath("//input[@id='foo_filter']");
		...
		public void addcustomer()
		{
			...
			driver.findElement(FULLNAME_FIELD).sendKeys("geet parekh");
		    ...
		    driver.findElement(EMAIL_FIELD).sendKeys("kitt@gmail.com");
			driver.findElement(PHONE).sendKeys("65892955");
			driver.findElement(ADDRESS).sendKeys("39,r3uabc");
			driver.findElement(CITY).sendKeys("dallas");
		...
		public void custList()
		{
			...
			driver.findElement(SEARCH).sendKeys("geet parekh");
